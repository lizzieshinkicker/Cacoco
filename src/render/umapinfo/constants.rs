...
pub const NORMAL_EXIT_COLOR: eframe::egui::Color32 = eframe::egui::Color32::from_rgb(80, 200, 80);
pub const SECRET_EXIT_COLOR: eframe::egui::Color32 = eframe::egui::Color32::from_rgb(220, 100, 180);
